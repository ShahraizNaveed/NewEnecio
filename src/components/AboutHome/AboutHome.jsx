...
const AboutHome = (props) => {
  return (
    <section
      className={
        props.hide == "true"
          ? "aboutHome-section aboutBg-color"
          : "aboutHome-section bg-color"
      }
    >
      <Container>
        <Row>
          <Col md={6}>
            <h1>
              ...
              <br />
              IN ONE OPEN SPACE  */}
              Seamless Integration in a Unified Construction Environment
            </h1>
            {props.hide == "false" && (
              <p className="small-para">
                We remain true to our founding values of quality, honesty and
                hard work.
                <br />
            ...
            {props.hide == "true" && (
              <div className="d-flex justify-content-between my-4">
                <div className="d-flex">
                  <div>
                    <img src={icon1} alt="Projects" className="img-fluid" />
                  </div>
                  <div className="mx-4">
                ...
                <div className="d-flex">
                  <div>
                    <img src={icon2} alt="Followers" className="img-fluid" />
                  </div>
                  <div className="mx-4">
            ...
            {props.hide == "false" && (
              <Link to="/about">
                <button className="left-side-btn">MORE ABOUT US</button>
              </Link>
            )}
          </Col>
          <Col md={6}>
